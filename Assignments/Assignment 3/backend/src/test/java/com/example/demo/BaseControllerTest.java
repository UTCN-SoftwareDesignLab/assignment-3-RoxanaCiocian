...
public abstract class BaseControllerTest {
    ...
    protected ResultActions performGetWithPathVariable(String path, Object pathVariable, Integer q) throws Exception {
    ...
    protected ResultActions performDeleteAll(String path) throws Exception {
